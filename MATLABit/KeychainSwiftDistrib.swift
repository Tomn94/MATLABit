...
open class KeychainSwift {
  ...
  */
  open func set(_ value: Foundation.Data, forKey key: String,
    withAccess access: KeychainSwiftAccessOptions? = nil) -> Bool {
  ...
  */
  open func set(_ value: Bool, forKey key: String,
    ...
    let data = Foundation.Data(bytes: &localValue, count: MemoryLayout<Bool>.size)
  ...
  */
  open func getData(_ key: String) -> Foundation.Data? {
    let prefixedKey = keyWithPrefix(key)
    ...
    if lastResultCode == noErr { return result as? Foundation.Data }
